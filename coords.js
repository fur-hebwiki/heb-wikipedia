function coords() {
	...
	if (/maps\.google/i.test(location.href)) 
		return GEvent.addListener(gApplication.getMap(), "click", function(junk, latlng) {p(latlng.lng(), latlng.lat());});
	if (/amudanan/i.test(location.href)) {
		$("#selectCoordinateSystem").val("WGS84LL");
		$("#divMap").mousedown(function(e){if(e.which>1)p($("#lblLon").html(), $("#lblLat").html());});
	}
}
(function ()
{
